...
Original B1–B5 / B8 (no app / no engine / no haptics / no privacy / no persistence) are **resolved in code**. B-DOC (stale test counts) resolved 2026-07-17. Treat remaining items above as launch gates, not missing scaffolding.
